...
Auto-generated from `related_works.tsv` (source of truth; keep edits in the TSV and regenerate).

**Totals:** 64 works: relevant = 21, math_foundation = 5, structural_duplicate = 3, cousin = 16, additive = 19
...
## Category index
### relevant — relevant - directly applicable to a repo claim (21)
...
### structural_duplicate — structural_duplicate - near-identical mechanism elsewhere (3)
...
### additive — additive - extends research direction (19)
