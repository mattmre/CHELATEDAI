...
- Iter 3: (next) verify availability of supporting rows (DualG-MRAG/MemGraphRAG/LogicRAG/CXL tier); promote to strong after confirmation; research shims/gating (MoE-based steering) and drift-experiment literature for c06/c13 depth.
