...
Status: active — iteration 17 continuation after segment 1 cap; corpus 23 claims; catalog 88 works / 77 strong / 100% claim coverage.
...
- Iter 17 (2026-08-15): research pass on works published in the last 6 months adjacent to the latest findings. Added 4 verified works from primary-source reads: PointCHR 2607.24052 (ICML 2026; curvature-aware hyperbolic rectification for 3D point clouds; c22), GreedySnake 2512.17570 (v2 2026-01; vertical scheduling + optimizer-step overlap; 1.96-2.53x vs ZeRO-Infinity; c23), MemAscend 2505.23254 (v4 2026-01, IEEE TETC; 55.7% peak memory reduction in SSD-offloaded fine-tuning; c23), Future-KL Regularized GRPO 2601.10201 (token-level credit via future reverse-KL correction; c21/c09; NOTE: 2601.10201 is FRPO, not PRL as mis-cited in loop_01/09 scan — corrected). Catalog 84->88 works; strong 73->77; coverage 100.0%.
