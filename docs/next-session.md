...
**Last session**: 2026-07-27 — PR #292 Tier-B reconditioning added first-cycle CD-MLR-01 and DS-MLR-01, quarantined legacy nDCG evidence, and retained a narrow durable backend-resolution proof. The flag remains CLEAR only because CD-MLR-01 has not yet survived a full cycle; it becomes BLOCKED if the debt expires open. Prior: 2026-06-13 PR #267 Track 0 hygiene closed CD-247-01 / CD-247-02.
