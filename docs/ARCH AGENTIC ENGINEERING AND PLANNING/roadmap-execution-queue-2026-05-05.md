...
| 22 | Preflight CI affordance | governance | next | CI or local command can run/link validation, audit, repeat decision, and preflight with clear fail-closed status |
