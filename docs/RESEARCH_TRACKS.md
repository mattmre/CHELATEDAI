...
Can ChelatedAI combine:

- SSD-resident model artifacts
- CPU-native low-bit execution
- optional sparse or MoE compression
- retrieval and graph memory for code

into one coherent non-GPU-first architecture?

### Current state

The research basis now exists, but the implementation roadmap is only partially reflected in the older docs.

The active program proposal is:

- [revised-roadmap-disk-first-program-2026-03-28.md](revised-roadmap-disk-first-program-2026-03-28.md)
- [disk-resident-llm-feasibility-2026-03-28.md](disk-resident-llm-feasibility-2026-03-28.md)
- [disk-resident-llm-addendum-reap-turboquant-2026-03-28.md](disk-resident-llm-addendum-reap-turboquant-2026-03-28.md)
