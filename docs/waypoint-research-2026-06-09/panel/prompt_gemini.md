PANEL ROLE — SYNTHESIS & DECISION: You are the reviewer who delivers the go/no-go. Given all the evidence, is the chelation hypothesis dead in BOTH regimes (drift + within-model collapse) or alive in one? What is the single highest expected-value path, and what concrete result would change your verdict? Be decisive and quantitative. Then answer the 3 questions.
